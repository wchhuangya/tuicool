package com.ch.wchhuangya.dzah.tuicool.activity;
...
import com.ch.wchhuangya.dzah.tuicool.fragment.ArticleFragment;

public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    public static final String TAG_ARTICLE = "FG_TAG_ARTICLE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.main_framelayout, new ArticleFragment(), TAG_ARTICLE).commit();
    }
